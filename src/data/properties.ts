...
A perfect blend of Nature, Agriculture, Tourism, and investment potential.`,
  ...
  },
  {
    ...
    houseSize: 0,
    yearBuilt: 0,
    description: `17km to Peradeniya town. Land is below hotel Club Lespri. Nilambe Eatate, Galaha.Clear deeds. Ideal to build a Holiday Bungalow with lovely view. Water & electricity line available.`,
    amenities: [],
    nearby: [],
    images: [
